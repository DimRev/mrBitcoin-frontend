...
function getContacts(filterBy: FilterBy | null = null): Promise<Contact[]> {
...
function _addContact(contact: Omit<Contact, '_id'>): Promise<Contact> {
  return new Promise((resolve, reject) => {
    const newContact = { ...contact, _id: _makeId() }
